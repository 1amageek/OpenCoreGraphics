...
public class CGGradient: @unchecked Sendable {
    ...
    public init?(colorsSpace: CGColorSpace?, colors: [CGColor], locations: UnsafePointer<CGFloat>?) {
        ...
        self.colorSpace = colorsSpace ?? colors[0].colorSpace ?? CGColorSpaceCreateDeviceRGB()
        self.colors = colors
        self.contentHeadroom = 1.0
    ...
    public init?(colors: [CGColor], locations: [CGFloat]?) {
        ...
        // Use the color space from the first color, or default to sRGB
        self.colorSpace = colors[0].colorSpace ?? CGColorSpaceCreateDeviceRGB()
        self.colors = colors
        self.locations = locations
        self.contentHeadroom = 1.0
    }
