...
enum FontTableTag {
    ...
    static let HVAR: UInt32 = 0x48564152  // 'HVAR'
    static let vhea: UInt32 = 0x76686561  // 'vhea'
    static let vmtx: UInt32 = 0x766D7478  // 'vmtx'
    static let VVAR: UInt32 = 0x56564152  // 'VVAR'
    static let VORG: UInt32 = 0x564F5247  // 'VORG'
    ...
    static let avar: UInt32 = 0x61766172  // 'avar'
