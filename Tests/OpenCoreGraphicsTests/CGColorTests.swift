...
struct CGColorTests {
    ...
    struct InitializationTests {
        ...
        func initWithGray() {
            ...
            #expect(color.components?[0].native == 0.5)
            #expect(color.components?[1].native == 1.0)
        ...
        func initWithRGB() {
            ...
            #expect(color.components?[0].native == 1.0)
            #expect(color.components?[1].native == 0.5)
            #expect(color.components?[2].native == 0.25)
            #expect(color.components?[3].native == 1.0)
        ...
        func initWithSRGB() {
            ...
            #expect(color.components?[1].native == 0.5)
            #expect(color.components?[2].native == 0.25)
            #expect(color.components?[3].native == 0.8)
        }
        ...
        func initWithCMYK() {
            ...
            #expect(color.components?[0].native == 0.2)
            #expect(color.components?[1].native == 0.4)
            #expect(color.components?[2].native == 0.6)
            #expect(color.components?[3].native == 0.1)
            #expect(color.components?[4].native == 1.0)
        ...
        func initWithGenericGray() {
            ...
            #expect(color.numberOfComponents == 2)
            #expect(color.components?[0].native == 0.7)
            #expect(color.components?[1].native == 0.9)
        }

        @Test("Init with color space and components")
        func initWithColorSpaceAndComponents() {
            let colorSpace = CGColorSpaceCreateDeviceRGB()
            var components: [CGFloat] = [1.0, 0.5, 0.25, 0.8]
    ...
    struct StaticColorsTests {
        ...
        func blackColor() {
            ...
            #expect(black.components?[0].native == 0.0)
            #expect(black.alpha.native == 1.0)
        }
        ...
        func whiteColor() {
            ...
            #expect(white.components?[0].native == 1.0)
            #expect(white.alpha.native == 1.0)
        }
        ...
        func clearColor() {
            ...
            #expect(clear.components?[0].native == 0.0)
            #expect(clear.alpha.native == 0.0)
        }
    }
    ...
    struct CopyTests {
        ...
        func copyWithAlpha() {
            ...
            #expect(copy != nil)
            #expect(copy?.alpha.native == 0.5)
            #expect(copy?.components?[0].native == 1.0) // Red unchanged
            #expect(copy?.components?[1].native == 0.5) // Green unchanged
            #expect(copy?.components?[2].native == 0.25) // Blue unchanged
        }
    ...
    struct ConversionTests {
        ...
        func convertToSameColorSpace() {
            ...
            #expect(converted?.components?[0].native == 1.0)
            #expect(converted?.components?[1].native == 0.5)
            #expect(converted?.components?[2].native == 0.25)
        }
        ...
        func convertGrayToRGB() {
            ...
            #expect(converted?.components?[0].native == 0.5) // R
            #expect(converted?.components?[1].native == 0.5) // G
            #expect(converted?.components?[2].native == 0.5) // B
            #expect(converted?.components?[3].native == 1.0) // A
        }
        ...
        func convertRGBToGray() {
            ...
            #expect(converted?.components?[0].native ?? 0 > 0.9)
        }
    }
    ...
    struct EdgeCaseTests {
        ...
        func zeroAlpha() {
            ...
            #expect(color.alpha.native == 0.0)
        }

        @Test("Full alpha")
        func fullAlpha() {
            let color = CGColor(red: 1.0, green: 0.5, blue: 0.25, alpha: 1.0)
            #expect(color.alpha.native == 1.0)
        }
        ...
        func componentBoundaries() {
            ...
            #expect(minColor.components?[0].native == 0.0)
            #expect(maxColor.components?[0].native == 1.0)
        }

        @Test("Very small component values")
        func verySmallComponents() {
            let color = CGColor(red: 0.001, green: 0.001, blue: 0.001, alpha: 1.0)
            #expect(color.components?[0].native == 0.001)
        }
    }
}
